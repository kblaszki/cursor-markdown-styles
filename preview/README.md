...
**Mermaid diagrams** do not render in this workbench — they appear as source code blocks. Test diagram styling in MPE with `examples/mermaid-showcase.md` and `themes/mpe/released/cpp-modern/`.
